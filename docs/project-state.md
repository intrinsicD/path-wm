...
The serial coordinator is active under runs/projection_training_2026-09-06. Read progress.json, stages.jsonl and logs/ for status; projection_comparison.json records all48 expected control outcomes including missing ones. The canonical dashboard refreshes and reconciles this derivative after each completed run/evaluation. The first arm began2026-09-06T19:39:40Z; expected total roughly10h including evaluations. The cumulative training-loop cap remains2100s per arm and stopped results remain explicit. The first seed is complete on both datasets (16/48 control outcomes). PushT calibrated1024/4096 scores3/2 at750 and2/4 at1500; saved scores3/1 and4/2. TwoRoom calibrated scores41/37 at750 and46/46 at1500; saved scores18/11 and43/47. All scores are out of50. The first seed gives no clear early learning-speed benefit from4096. Seed3073 is active; seed3074 remains queued. All four preselected qualitative panels are verified and inspected. Final audits, tests and exports are queued after the scientific coordinator. See the [interim report](projection-training-2026-09-06.md).
