...
The serial coordinator is active under runs/projection_training_2026-09-06. Read progress.json, stages.jsonl and logs/ for status; projection_comparison.json records all48 expected control outcomes including missing ones. The canonical dashboard refreshes and reconciles this derivative after each completed run/evaluation. The first arm began2026-09-06T19:39:40Z; expected total roughly10h including evaluations. The cumulative training-loop cap remains2100s per arm and stopped results remain explicit. The first PushT pair is complete: calibrated1024/4096 scores3/2 at750 and2/4 at1500, while saved scores3/1 and4/2 (all out of50). This is mixed evidence from one seed. The first TwoRoom4096 arm completes1500 updates: saved/calibrated control11/37 at750 and47/46 at1500. Its1024 counterpart and seeds3073/3074 remain pending; the larger-sketch effect is not yet known on TwoRoom. Final audits, tests and exports are queued after the scientific coordinator. See the [interim report](projection-training-2026-09-06.md).
