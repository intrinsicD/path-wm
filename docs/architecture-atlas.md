...
16 September public-reference design: preserve the shared latent core and versioned evidence/entity memory; propose measured detail/semantic adapters, causal temporal features and modality-specific generation. Literature/Claude review is not capability validation. RTX3050 8GiB confirmed; new training fit unmeasured. See docs/multimodal-reference-design.md. No implemented topology or discussion/validation color changes.

16 September extended primary-source/Claude review: multi-layer access and action-labelled latent prediction are comparison candidates. LeWM was trained on L40S; RAEv2 layer aggregation is not inherently cross-scale; SemantiCodec long bidirectional chunks do not supply causal streaming. Preserve the shared latent core, codecs and evidence graph until a local resource/quality comparison passes. No capability or discussion-status promotion.

16 September: recurring understanding regression adds10 controlled semantic/temporal families and15 real urban-scene evidence subsets, including all modality combinations. Actual byte-decoder answers, required-source/no-evidence controls and paired success remain separate from frozen encoder/posterior/working probes. Both existing joint checkpoints fail25/25 quick acceptance screens. The text output was trained on short symbolic outputs, not these German question-answer tasks. No inference/default change or green capability promotion. See docs/understanding-suite-plan.md.

16 September suite-directed QA continuation: four matched decoder/core fits keep encoders frozen. Source7202 core+decoder passes controlled VID.order (100% choice accuracy/pairs across3 draws;50% omission), reaching1/25 quick tasks. Free generation14/16; source7201 remains50%. Old symbolic outputs regress in all arms, so defaults and broad validation colors stay unchanged. Decoder normalization probes do not show systematic signal destruction. Next stabilize temporal core access and preserve task/output behavior. See docs/grounded-readout-plan.md.

Training-only retention ablation: four768-update fits reduce old-output forgetting but fail overall adoption; no inference changes or broad green promotion. Controlled video-order choice success is separate from free answer generation. See docs/grounded-retention-plan.md and runs/grounded_retention_v1/report.html.

Source: [experiments/multimodal.py · build_model:103](../experiments/multimodal.py), [pathwm/models/belief.py · BeliefAgent:102](../pathwm/models/belief.py), [pathwm/models/agent.py · step_task:637](../pathwm/models/agent.py), [docs/multimodal-reference-design.md](../docs/multimodal-reference-design.md), [docs/multimodal-reference-extension.md](../docs/multimodal-reference-extension.md), [pathwm/data/understanding.py · UnderstandingData:488](../pathwm/data/understanding.py), [pathwm/evaluation/understanding.py · evaluate_understanding:233](../pathwm/evaluation/understanding.py), [docs/understanding-suite-plan.md](../docs/understanding-suite-plan.md), [docs/grounded-readout-plan.md](../docs/grounded-readout-plan.md), [experiments/modality_readout.py · grounded:1353](../experiments/modality_readout.py).
...
Source: [pathwm/models/agent.py · Thinker:105](../pathwm/models/agent.py), [pathwm/models/agent.py · emit:508](../pathwm/models/agent.py), [pathwm/models/modalities.py · TextDecoder:366](../pathwm/models/modalities.py), [pathwm/models/modalities.py · ImageDecoder:282](../pathwm/models/modalities.py), [pathwm/models/modalities.py · AudioDecoder:347](../pathwm/models/modalities.py), [pathwm/models/conditional_image.py · ConditionalFeatureGenerator:73](../pathwm/models/conditional_image.py), [docs/multimodal.md](../docs/multimodal.md), [docs/latent-core.md](../docs/latent-core.md), [pathwm/models/readout.py · RecurrentOutputAdapter:9](../pathwm/models/readout.py), [pathwm/models/readout.py · TemporalImageDecoder:72](../pathwm/models/readout.py), [docs/modality-readout-plan.md](../docs/modality-readout-plan.md), [pathwm/evaluation/modality_suite.py](../pathwm/evaluation/modality_suite.py), [docs/modality-suites-plan.md](../docs/modality-suites-plan.md), [docs/multimodal-reference-design.md](../docs/multimodal-reference-design.md), [docs/multimodal-reference-extension.md](../docs/multimodal-reference-extension.md), [pathwm/data/understanding.py · UnderstandingData:488](../pathwm/data/understanding.py), [pathwm/evaluation/understanding.py · evaluate_understanding:233](../pathwm/evaluation/understanding.py), [docs/understanding-suite-plan.md](../docs/understanding-suite-plan.md), [docs/grounded-readout-plan.md](../docs/grounded-readout-plan.md), [experiments/modality_readout.py · grounded:1353](../experiments/modality_readout.py).
...
Initialization/transfer comparison: optional RGB reflection before encoding and independent head/sampler seeds in the direction recipe. Eight fixed fits all reach100% train accuracy, but only one of four cells passes per arm; reflection mean+1.37pp and worst-5.60pp fails repair criteria. Both temporal/head initializations affect observed transfer under identical sampling. No architecture/default or green promotion.72 tests,2211 exact restart and7828 raw audits; see docs/video-stability-plan.md and runs/video_stability_v1/report.html.

Source-diversity comparison changes data only:4x4 versus4x16 versus16x4 clips/frames,12 fixed fits. Fresh four-subject confirmation at trained2/4px improves98.23→99.93%, but untrained6/8px is83.61/83.16/77.51%. Full capability and diversity-benefit gates fail; no default or green promotion. Optional source manifests, source-macro metrics and sampled exposure are inspectable.74 tests,3571 exact restart and14771 raw audits; see docs/video-diversity-plan.md. Next displacement coverage is proposed, not implemented.

16 September displacement coverage: eight matched512-update fits compare2/4 versus2/4/6/8px support on identical16x4 frames and image/phase draws. Fresh sources: intermediate92.73→97.65%, extrapolated10/11px58.89→85.03%; known99.64→97.05% with worst9.64pp regression. Full capability and preservation gates fail; no default promotion.77 tests,3397 exact restart,19873 raw checks,4560 marginal identities. Post-hoc reversed-partner score ordering reveals a common class offset, not a validated single-clip repair; next compare paired training objectives with explicit inference contract. Natural video and streaming remain open.

16 September paired-objective comparison:8 fixed fits keep inference one sequence/model unchanged and add training-only0.1 SmoothL1 common class-score offset. Fresh source accuracy known95.90→98.59%,wide89.62→92.92%,intermediate93.67→96.84%,extrapolation69.54→72.42%. Absolute/relative class preference decreases, but large-shift ordering remains weak. Full capability/preservation gates fail; no default promotion.81 tests,7061 restart,52913 raw audits and72 exact prior-baseline checks;11 structural reports, plot inspected. Explicit two-frame correspondence is proposed next; no natural-video or core-integration claim.

16 September explicit correspondence support:12 fixed fits share radius3 crop/head/1630 nominal parameters and expose no/local2/wide3 matching. Fresh10/11px accuracy78.75/86.77/90.07%, while a mandatory fixed cosine rule on the SAME frozen grids reaches99.93%. Direction evidence is accessible for these constructed pans; generic learned readout remains unreliable. All trained full/preservation gates fail, no default/color promotion.85 tests,8661 restart,92229 raw checks,5256 marginal identities,17 structural reports; plot inspected. Next structured opposite-offset readout is proposed, not implemented. See docs/video-matching-plan.md and runs/video_matching_v1/report.html.

16 September structured direction readout: shared81-parameter cosine/absolute-offset/zero-match residual scorer compares signed-side maxima, with no temporal/appearance inputs. Four512-step fits: fresh99.69–100% and both-seed capability passes, fixed cosine also passes. Learned-vs-fixed gain0.0366pp and inspected-source regression14.71pp fail adoption; wider correct matches are often replaced by offset1. No default or high-level green promotion.89 tests,10239 restart,42682 raw audits,36 exact old pooled checks,8 structural reports/inspected panel. See docs/video-evidence-plan.md; not natural motion or core integration.

16 September public-reference design: preserve the shared latent core and versioned evidence/entity memory; propose measured detail/semantic adapters, causal temporal features and modality-specific generation. Literature/Claude review is not capability validation. RTX3050 8GiB confirmed; new training fit unmeasured. See docs/multimodal-reference-design.md. No implemented topology or discussion/validation color changes.

16 September extended primary-source/Claude review: multi-layer access and action-labelled latent prediction are comparison candidates. LeWM was trained on L40S; RAEv2 layer aggregation is not inherently cross-scale; SemantiCodec long bidirectional chunks do not supply causal streaming. Preserve the shared latent core, codecs and evidence graph until a local resource/quality comparison passes. No capability or discussion-status promotion.

Source: [pathwm/models/video_vae.py · VideoVAE:149](../pathwm/models/video_vae.py), [pathwm/models/video_vae.py · CausalLatentMixer:19](../pathwm/models/video_vae.py), [experiments/video_vae.py](../experiments/video_vae.py), [tests/test_video_vae.py](../tests/test_video_vae.py), [docs/shared-video-vae-plan.md](../docs/shared-video-vae-plan.md), [docs/video-context-plan.md](../docs/video-context-plan.md), [pathwm/models/video_vae.py · local_correlation:71](../pathwm/models/video_vae.py), [pathwm/data/video_order.py · cyclic_pan_pairs:59](../pathwm/data/video_order.py), [experiments/video_order.py · OrderReadout:55](../experiments/video_order.py), [docs/video-order-plan.md](../docs/video-order-plan.md), [docs/video-stability-plan.md](../docs/video-stability-plan.md), [docs/video-diversity-plan.md](../docs/video-diversity-plan.md), [docs/video-displacement-plan.md](../docs/video-displacement-plan.md), [docs/video-pair-center-plan.md](../docs/video-pair-center-plan.md), [docs/video-matching-plan.md](../docs/video-matching-plan.md), [pathwm/models/video_vae.py · CorrespondenceDirectionHead:96](../pathwm/models/video_vae.py), [tests/test_video_evidence.py](../tests/test_video_evidence.py), [docs/video-evidence-plan.md](../docs/video-evidence-plan.md), [docs/multimodal-reference-design.md](../docs/multimodal-reference-design.md), [docs/multimodal-reference-extension.md](../docs/multimodal-reference-extension.md).
